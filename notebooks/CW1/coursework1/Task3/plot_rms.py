...
for run in results:
    ax_1.plot(np.arange(1, run[1].shape[0]) * 5,
              run[1][1:, run[2]['error(train)']], label='rate='+str(run[0][0])+' eps='+str(run[0][1])+' beta='+str(run[0][2]),c=next(color))
ax_1.legend(loc=0)
...
for run in results:
    ax_2.plot(np.arange(1, run[1].shape[0]) * 5,
              run[1][1:, run[2]['error(valid)']], label='rate='+str(run[0][0])+' eps='+str(run[0][1])+' beta='+str(run[0][2]),c=next(color))
ax_2.legend(loc=0)
...
for run in results:
    ax_3.plot(np.arange(1, run[1].shape[0]) * 5,
              run[1][1:, run[2]['acc(train)']], label='rate='+str(run[0][0])+' eps='+str(run[0][1])+' beta='+str(run[0][2]),c=next(color))
ax_3.legend(loc=0)
...
for run in results:
    ax_4.plot(np.arange(1, run[1].shape[0]) * 5,
              run[1][1:, run[2]['acc(valid)']], label='rate='+str(run[0][0])+' eps='+str(run[0][1])+' beta='+str(run[0][2]),c=next(color))
ax_4.legend(loc=0)
