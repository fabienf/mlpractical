...
for run in results:
    ax_1.plot(np.arange(1, run[1].shape[0]) * 5,
              run[1][1:, run[2]['error(train)']], label='n = '+str(run[0][0])+' r = '+str(run[0][1]),c=next(color))
ax_1.legend(loc=0)
...
for run in results:
    ax_2.plot(np.arange(1, run[1].shape[0]) * 5,
              run[1][1:, run[2]['error(valid)']], label='n = '+str(run[0][0])+' r = '+str(run[0][1]),c=next(color))
ax_2.legend(loc=0)
...
for run in results:
    ax_3.plot(np.arange(1, run[1].shape[0]) * 5,
              run[1][1:, run[2]['acc(train)']], label='n = '+str(run[0][0])+' r = '+str(run[0][1]),c=next(color))
ax_3.legend(loc=0)
...
for run in results:
    ax_4.plot(np.arange(1, run[1].shape[0]) * 5,
              run[1][1:, run[2]['acc(valid)']], label='n = '+str(run[0][0])+' r = '+str(run[0][1]),c=next(color))
ax_4.legend(loc=0)
