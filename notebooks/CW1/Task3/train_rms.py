...
from mlp.learning_rules import RMSGradLearningRule
...
def setup_run_with_param(param):
    ...
    learning_rule = RMSGradLearningRule(learning_rate,eps,beta)
    ...
    print('       param '+ str(learning_rate)+' '+str(eps) +' '+str(beta))
...
tested_params = [[0.9,1e-8,0.9],[0.2,1e-8,0.9],[0.05,1e-8,0.9],[0.01,1e-8,0.9],[0.001,1e-8,0.9],[0.9,1e-8,0.5],[0.2,1e-8,0.5],[0.05,1e-8,0.5],[0.01,1e-8,0.5],[0.001,1e-8,0.5],[0.9,1e-8,0.2],[0.2,1e-8,0.2],[0.05,1e-8,0.2],[0.01,1e-8,0.2],[0.001,1e-8,0.2]]
...
#setup_run_with_param([0.2,1e-8,0.9])
